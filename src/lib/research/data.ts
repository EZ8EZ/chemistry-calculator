...
export interface CycleStep {
  ...
  /** Bond being formed or broken */
  bondEvent?: string;
  /** Experimental evidence for this step */
  evidence?: string;
    ...
    steps: [
      {
        ...
        species: "Co\u1D35\u1D35(Por)",
        description: "The resting-state 15-electron d\u2077 metalloradical. A stable, persistent radical that does not dimerize due to steric shielding by the porphyrin macrocycle.",
        electronConfig: "d\u2077 \u2014 15e\u207B complex",
        significance: "Unlike closed-shell catalysts, the open-shell d\u2077 configuration enables homolytic (one-electron) bond activation \u2014 the foundation of MRC.",
        evidence: "Paramagnetic NMR, magnetic susceptibility measurements confirm S = 1/2 ground state.",
      },
      {
        id: "carbene-2",
        label: "Diazo Activation",
        species: "Co\u1D35\u1D35(Por) + N\u2082=CHCO\u2082Et",
        description: "The Co(II) metalloradical activates the diazo compound via single-electron transfer, forming a Co\u2013C bond with concurrent N\u2082 extrusion. This is a homolytic process, not the heterolytic activation seen in Rh(II)/Cu(I) catalysis.",
        electronConfig: "Homolytic activation \u2014 \u0394G\u2021 lowered by radical pathway",
        bondEvent: "Co\u2013C bond formation + N\u2082 extrusion",
        significance: "The radical activation pathway is kinetically distinct from classical metal-carbene formation, enabling unique selectivity patterns.",
      },
      {
        id: "carbene-3",
        label: "Co(III)-Carbene Radical",
        species: "Co\u1D35\u1D35\u1D35(Por)(\u00B7CR\u2082)",
        description: "The key intermediate: an \u03B1-metalloalkyl radical with significant spin density on the carbene carbon (Mulliken spin population ~0.5). This is NOT a Fischer or Schrock carbene \u2014 it is a true radical species.",
        electronConfig: "d\u2076 Co(III) + carbon radical \u2014 16e\u207B complex",
        bondEvent: "Single Co\u2013C bond (not double bond as in Fischer carbenes)",
        evidence: "Detected by EPR spectroscopy (Dzik, de Bruin, Zhang, JACS 2011). DFT calculations show spin density delocalized on carbon.",
        significance: "This radical character enables the stepwise, stereochemistry-determining addition to olefins \u2014 fundamentally different from concerted [2+1] in Rh(II) catalysis.",
      },
      {
        id: "carbene-4",
        label: "Radical Addition to Olefin",
        species: "Co\u1D35\u1D35\u1D35(Por)(CR\u2082\u2013CH\u2082\u2013\u00B7CHAr)",
        description: "The carbene radical adds to the olefin substrate in a stepwise fashion, forming a new C\u2013C bond and generating a \u03B3-radical. The chiral porphyrin environment controls the facial selectivity of this addition.",
        electronConfig: "Radical addition \u2014 stereochemistry set here",
        bondEvent: "First C\u2013C bond formed (radical addition)",
        significance: "Stepwise radical addition allows for high enantioselectivity (>95% ee) controlled by the chiral porphyrin \u2014 not achievable by concerted pathways.",
      },
      {
        id: "carbene-5",
        label: "3-exo-trig Cyclization",
        species: "Co\u1D35\u1D35(Por) + cyclopropane",
        description: "The \u03B3-radical undergoes intramolecular 3-exo-trig cyclization with concomitant homolysis of the Co\u2013C bond, regenerating the Co(II) catalyst and releasing the cyclopropane product in a single concerted step.",
        electronConfig: "Catalyst turnover \u2014 back to d\u2077 15e\u207B",
        bondEvent: "Second C\u2013C bond formed + Co\u2013C bond broken (homolysis)",
        significance: "Simultaneous ring closure and catalyst regeneration ensures high turnover. The trans-selectivity of cyclopropanation is controlled at this stage.",
      },
    ],
    ...
    steps: [
      {
        ...
        label: "Co(II) Porphyrin",
        species: "Co\u1D35\u1D35(Por)",
        description: "The same resting-state d\u2077 metalloradical as the carbene cycle. The versatility of this single catalyst platform for both carbene and nitrene chemistry is a hallmark of MRC.",
        electronConfig: "d\u2077 \u2014 15e\u207B complex",
        significance: "One catalyst platform, two fundamentally different reactive intermediates (carbene vs. nitrene radicals) \u2014 controlled by reagent choice.",
      },
      {
        id: "nitrene-2",
        label: "Azide Activation",
        species: "Co\u1D35\u1D35(Por) + RN\u2083",
        description: "The organic azide coordinates to Co(II) and undergoes homolytic N\u2013N\u2082 cleavage. Unlike traditional nitrene transfer (Rh, Mn), no PhI=NR oxidant or hypervalent iodine reagent is needed. N\u2082 is the only byproduct.",
        electronConfig: "One-electron activation \u2014 no external oxidant needed",
        bondEvent: "Co\u2013N bond formation + N\u2082 extrusion",
        significance: "Using organic azides as direct nitrene sources is atom-economical and avoids waste from iodoarene-based nitrene precursors.",
      },
      {
        id: "nitrene-3",
        label: "Co(III)-Nitrene Radical",
        species: "Co\u1D35\u1D35\u1D35(Por)(\u00B7NR)",
        description: "An \u03B1-metalloaminyl radical (imidyl radical). Spin density resides primarily on nitrogen (~0.6 Mulliken population). This is NOT a metal-nitrenoid with M=N double bond \u2014 it has a single Co\u2013N bond and radical character on N.",
        electronConfig: "d\u2076 Co(III) + nitrogen radical \u2014 16e\u207B complex",
        bondEvent: "Single Co\u2013N bond (not M=N as in Rh/Mn nitrenoids)",
        evidence: "EPR spectroscopy and DFT (Lu, Zhang, JACS 2015) confirm nitrogen-centered radical character. Distinct from metal-nitrenoid species.",
        significance: "The radical character on nitrogen enables unique reactivity: HAT from strong C\u2013H bonds, selectivity patterns inaccessible to electrophilic metal-nitrenoids.",
      },
      {
        id: "nitrene-4",
        label: "H-Atom Abstraction",
        species: "Co\u1D35\u1D35\u1D35(Por)(NHR) + \u00B7C\u2013",
        description: "The nitrene radical abstracts a hydrogen atom from the substrate C\u2013H bond in a thermodynamically favorable step (BDE of forming N\u2013H > BDE of breaking C\u2013H). Generates a carbon-centered radical and a Co(III)-amido species.",
        electronConfig: "HAT: BDE(N\u2013H) \u2248 100 kcal/mol > BDE(C\u2013H) \u2248 90\u201395 kcal/mol",
        bondEvent: "C\u2013H bond broken (homolytic) + N\u2013H bond formed",
        significance: "The HAT step is site-selective: weaker C\u2013H bonds (benzylic, allylic, \u03B1-to-O) react preferentially. Steric effects of the porphyrin provide additional selectivity.",
      },
      {
        id: "nitrene-5",
        label: "Radical Rebound",
        species: "Co\u1D35\u1D35(Por) + R\u2013NH\u2013R\u2032",
        description: "The carbon radical rebounds to nitrogen in a cage-controlled process, forming the C\u2013N bond. The Co\u2013N bond homolyzes simultaneously, regenerating the Co(II) catalyst. Stereochemistry is determined by this rebound step.",
        electronConfig: "Catalyst turnover \u2014 back to d\u2077 15e\u207B",
        bondEvent: "C\u2013N bond formed + Co\u2013N bond broken (homolysis)",
        significance: "The chiral porphyrin controls facial selectivity during rebound, achieving high enantioselectivity in intermolecular C\u2013H amination.",
      },
    ],
